...
<div class="header">Have an idea you want created?</div>
...
<div class="title">What services do I offer?</div>

<table>
    {#each commissions as { service, description }}
        <tr>
...
<div class="title">How do I contact and commission you?</div>
